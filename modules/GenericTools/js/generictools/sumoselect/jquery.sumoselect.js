...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: 'בחירה',   // Dont change it here.
            csvDispCount: 3,              // display no. of items in multiselect. 0 to display all.
            captionFormat: '{0} אלמנטים נבחרו', // format of caption text. you can set your locale.
            captionFormatAllSelected: ' כל האלמנטים נבחרו!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
            ...
            searchText: 'חיפוש...',      // placeholder for search input
            noMatch: 'לא נמצאו אלמנטים עבור "{0}"',
            prefix: '',                   // some prefix usually the field name. eg. '<b>Hello</b>'
            locale: ['אישור', 'ביטול', 'בחר בכל'],  // all text that is used. don't change the index.
