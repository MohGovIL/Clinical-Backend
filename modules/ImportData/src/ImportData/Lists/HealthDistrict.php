...
class HealthDistrict extends BaseList implements InterfaceList
{
    ...
    public $uniqueListName = 'health_district';
    ...
    public function __construct($EDMdata){
        ...
        if(is_null($this->EDMdata['Code']) || $this->EDMdata['Code'] === ""  || is_null($this->EDMdata['Description_heb'])){
    ...
    public function convertKeys(){
        ...
        $this->clinikalData['notes'] =  empty($this->EDMdata['Health_region_code']) ? $this->EDMdata['Health_region_code'] :0;
    ...
    public function getTranslation(){
        ...
        return array(
            ...
            'hebrew' => $this->EDMdata['Description_heb']
        );
    }
