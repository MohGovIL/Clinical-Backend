...
class SsoList extends BaseList implements InterfaceList
{

    public static $table = ImportDataController::SSO_LIST;
    ...
    public function __construct($EDMdata){
        ...
        if(is_null($this->EDMdata['Code']) || $this->EDMdata['Code'] === ""  || is_null($this->EDMdata['City'])){
    ...
    public function getTranslation(){
        //title of SSO is city name (already exist)
        return array();
    }
