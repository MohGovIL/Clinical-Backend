...
class GenderList extends BaseList implements InterfaceList
{
    ...
    public function convertKeys(){
        ...
        switch ($this->EDMdata['Code']){
            case '1':
                $this->clinikalData['option_id'] = 'Male';
                if(is_null($this->EDMdata['Description_eng']))$this->EDMdata['Description_eng'] = 'Male';
                break;
            case '2':
                $this->clinikalData['option_id'] = 'Female';
                if(is_null($this->EDMdata['Description_eng']))$this->EDMdata['Description_eng'] = 'Female';
                break;
            default:
