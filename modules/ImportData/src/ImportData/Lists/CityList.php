...
class CityList extends BaseList implements InterfaceList
{
    ...
    public function convertKeys(){
        ...
        $this->clinikalData['notes'] = empty($this->EDMdata['Health_district_code']) ?null : $this->EDMdata['Health_district_code'];
